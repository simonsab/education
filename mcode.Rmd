...
```
-------------------------------------------------
```{r, define_vars, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r, make_dataset, echo = TRUE, results = 'hide'}
################### Making the datasets ####################################
...
```
-------------------------------------------------
```{r, var_manipulation, echo = TRUE, results = 'hide'}
################### Combining Variables #######################################
...
```
-------------------------------------------------
```{r, making_graphs, echo = TRUE, results = 'hide'}
################### Graphs #############################################
