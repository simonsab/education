...
```
-------------------------------------------------
```{r defining poverty variables, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r new dataset7, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r, rowwise summaries2, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r tidying, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r percentages5, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r interesting variables, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r defining age variables, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r new dataset5, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r rowwise summaries7, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r cleaning the data, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r percentages9, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r Variable plot, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r most interesting variables, echo = TRUE, results = 'hide'}
#box plot
...
```
-------------------------------------------------
```{r leaflet map 1, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r leaflet map 2, echo = TRUE, results = 'hide'}
...
```
-------------------------------------------------
```{r leaflet map 3, echo = TRUE, results = 'hide'}
