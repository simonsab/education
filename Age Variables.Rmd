...
The map below shows the count of all males above 65 with a High School Diplomas in each county.
...
The map below shows the count of all females above 65 with a High School Diplomas in each county.
...
In the above maps, we see that the area around Detroit has the largest numbers while the counties in the upper peninsula have the least.
